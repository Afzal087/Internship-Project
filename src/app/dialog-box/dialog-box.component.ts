...
@Component({
  ...
  <div class="fixed inset-0 flex items-center justify-center bg-black/40 z-[9999]"
    ...
    <div (click)="$event.stopPropagation()"
         class="bg-white rounded-xl shadow-2xl w-[90%] max-w-md overflow-hidden border border-gray-200">
      ...
      <div class="px-6 py-4 bg-white border-t border-gray-200 flex justify-end">
        <button (click)="dialog.hide()"
                class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-150 shadow-sm hover:shadow-md">
          OK
        </button>
      </div>
    </div>
